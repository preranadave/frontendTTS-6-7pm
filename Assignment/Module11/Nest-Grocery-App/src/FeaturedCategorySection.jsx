...
function FeaturedCategorySection() {
  ...
  return (
    <div className="mt-2 py-5 px-5 featured-categories">
      ...
      <IoIosArrowRoundBack size={40} className="bg-gray-300 rounded-full absolute top-20 p-2 z-10 hover:bg-green-500 cursor-pointer" onClick={SlideLeft}/>
        ...
        <IoIosArrowRoundForward size={40} className="bg-gray-300 rounded-full absolute top-20 right-1 translate-x-5 p-2 hover:bg-green-500 cursor-pointer" onClick={SlideRight}/>
      </div>
    </div>
  );
}
